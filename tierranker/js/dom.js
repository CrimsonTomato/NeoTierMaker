// --- All DOM element lookups are centralized here ---

export const viewInput = document.getElementById('view-input');
export const textInputArea = document.getElementById('text-input-area');
export const addFromTextBtn = document.getElementById('btn-add-from-text');
export const clearStagingBtn = document.getElementById('btn-clear-staging');
export const uploadImagesBtn = document.getElementById('btn-upload-images');
...
export const btnSizeIncrease = document.getElementById('btn-size-increase');
export const btnSizeDecrease = document.getElementById('btn-size-decrease');
export const btnExportSession = document.getElementById('btn-export-session');
